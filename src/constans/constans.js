...
export const announcementData = [
	{
		...
		description: 'Radiogram Perpanjangan Batas Akhir Penginputan Indeks Inovasi Daerah Tahun 2023',
	},
	{
		date: '16 Februari 2023',
...
export const GET_ALL_INDICATOR_PEMDA_PROFILES = 'get_all_indicator_pemda_profiles';
export const UPLOAD_INDICATOR_DOCUMENT_PEMDA_PROFILE = 'upload_indicator_document_pemda_profile';

export const DELETE_INDICATOR_DOCUMENT_PEMDA_PROFILE = 'delete_indicator_document_pemda_profile';
...
export const GET_ALL_REGIONAL_INNOVATION_QUERY_KEY = 'get_all_regional_innovation';
export const GET_REGIONAL_INNOVATION_QUERY_KEY = 'get_regional_innovation';
export const GET_INDICATOR_REGIONAL_INNOVATION_QUERY_KEY = 'get_indicator_regional_innovation';

export const GET_ALL_DOCUMENT_REGIONAL_INNOVATION_QUERY_KEY = 'get_all_document_regional_innovation';
export const GET_DOWNLOAD_EXCEL_REGIONAL_INNOVATION_QUERY_KEY = 'get_download_excel_regional_innovation';
...
export const GET_ALL_REGIONAL_INNOVATION_REVIEW = 'get_all_regional_innovation_review';
export const GET_ALL_REGIONAL_INNOVATION_REVIEW_BY_ID = 'get_all_regional_innovation_review_by_id';
export const GET_REGIONAL_INNOVATION_REVIEW_BY_INNOVATION_PROFILE = 'get_regional_innovation_review_by_innovation_profile';
export const GET_REGIONAL_INNOVATION_REVIEW_BY_INDICATOR = 'get_regional_innovation_review_by_indicator';
export const GET_REGIONAL_INNOVATION_REVIEW_EVALUATION = 'get_regional_innovation_review_evaluation';
...
export const GET_ALL_REGIONAL_GOVERNMENT_INNOVATION = 'get_all_regional_government_innovation';
