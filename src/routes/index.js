...
import RegionalInnovationScoreForm from './DatabaseInnovation/RegionalInnovation/ScoreForm';
...
const innovationDatabaseRoutes = [
  ...
  {
    path: '/inovasi-daerah/edit/skor_kematangan/:id',
    element: <RegionalInnovationScoreForm />,
    roles: ['Super Admin'],
  },
  {
