...
import { guideData } from "../../../constans/constans";
    ...
    <div className="w-full rounded-xl bg-[#E2F8FF] py-8 px-6 flex flex-col">
      <div className="w-full flex items-center justify-between">
        ...
        <div className="min-w-[356px] flex items-center gap-3 bg-white rounded py-3 px-4">
            ...
            <input type="text" className="outline-none text-sm placeholder:text-sm text-[#828282] placeholder:text-[#828282]" placeholder="Pencarian" />
        </div>
      </div>
      <div className="flex flex-col flex-1 overflow-scroll gap-3 mt-6">
        {guideData.map((guide, key) => (
